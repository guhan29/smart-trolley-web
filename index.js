...
var dataset = [
  ...
  ['Apple', 'Bread', 'Milk'],
  ['Bread', 'Butter', 'Milk'],
  ['Apple', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ...
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Milk', 'Biscuit', 'VixInhaler', 'VoliniSpray'],
  ['Apple', 'Biscuit', 'VixInhaler', 'VoliniSpray'],
  ['Bread', 'Butter', 'Jam', 'VoliniSpray'],
  ['Bread', 'Butter', 'VoliniSpray', 'VixInhaler'],
  ['Bread', 'Butter', 'VoliniSpray', 'VixInhaler'],
  ['Bread', 'Butter', 'VoliniSpray', 'VixInhaler'],
  ['Bread', 'Butter', 'VoliniSpray', 'VixInhaler'],
  ['Bread', 'Butter', 'VoliniSpray', 'VixInhaler'],
